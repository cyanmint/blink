...
-Wl,-headerpad_max_install_names -Wl,-x -Wl,-no_function_starts -Wl,-no_data_in_code_info -Wl,-all_load "$TARGET_ROOT/$PYTHON_LIBRARY" \
  -Wl,-force_load,"$TARGET_ROOT/Modules/_decimal/libmpdec/libmpdec.a" \
